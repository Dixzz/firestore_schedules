...
class MaterialWithModalsPageRoute<T> extends mt.MaterialPageRoute<T> {
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    return (nextRoute is mt.MaterialPageRoute && !nextRoute.fullscreenDialog) ||
  ...
  Widget buildTransitions(BuildContext context, Animation<double> animation,
    ...
    final theme = mt.Theme.of(context).pageTransitionsTheme;
