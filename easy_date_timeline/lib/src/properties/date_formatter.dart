...
class DayOnlyFormatter extends DateFormatter {
  /// Formats the date with only the day of the week for example "Monday".
  ///
  /// Example usage:
  /// ```dart
...
class MonthOnlyFormatter extends DateFormatter {
  /// Formats the date with only the month for example "January".
  ///
  /// Example usage:
  /// ```dart
...
class FullDateDMYFormatter extends DateFormatter {
  /// Formats the date as "day/month/year" (e.g., "01/01/2022").
  ///
  /// Example usage:
  /// ```dart
...
class FullDateMDYFormatter extends DateFormatter {
...
class FullDateDayAsStrMYFormatter extends DateFormatter {
...
class FullDateDMonthAsStrYFormatter extends DateFormatter {
  /// Formats the date as "day month year" (e.g., "1 January, 2022").
  ///
  /// Example usage:
  /// ```dart
...
class FullDateMonthAsStrDYFormatter extends DateFormatter {
  /// Formats the date as "month day year" (e.g., "June 11,2023").
  ///
  /// Example usage:
  /// ```dart
...
class CustomFormatter extends DateFormatter {
  /// Formats the date using a custom formatter string provided by the user.
  ///
  /// Example usage:
  /// ```dart
